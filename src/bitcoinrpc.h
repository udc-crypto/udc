...
json_spirit::Object PrintError(int code, const std::string& message);
...
/*
  Type-check arguments; throws PrintError if wrong type given. Does not check that
...
extern double GetDifficulty(const PoWCompBlkIndex* blockindex = NULL);
