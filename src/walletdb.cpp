...
bool
ReadKeyValue(CWallet* pwallet, cdatastreams& ssKey, cdatastreams& ssValue,
...
void ThreadFlushWalletDB(void* parg)
{
    ...
    RenameThread("universaldigitalcoin-wallet");
...
bool CWalletDB::Recover(CDBEnv& dbenv, std::string filename, bool fOnlyKeys)
{
    ...
    BOOST_FOREACH(CDBEnv::KeyValPair& row, salvagedData)
    {
        if (fOnlyKeys)
        {
            cdatastreams ssKey(row.first, SER_DISK, CLIENT_VERSION);
            cdatastreams ssValue(row.second, SER_DISK, CLIENT_VERSION);
            string strType, strErr;
